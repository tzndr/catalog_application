...
APPLICATION_NAME = 'General Clothing Catalog'


engine = create_engine('sqlite:///generalclothingcatalog.db')
...
@app.route('/categories/<int:category_id>/products/<int:item_id>/JSON/')
@app.route('/categories/<int:category_id>/products/<int:item_id>/detail/JSON/')
...
@app.route('/categoreies/<int:category_id>/products/')
...
def newProduct(category_id):
    ...
    if login_session['user_id'] != category.user.id:
        return flash("You aren't authorized to edit these products. Please log in")
    if request.method == 'POST':
...
@app.route('/categories/<int:category_id>/products/<int:item_id>/edit/',
    methods = ['GET', 'POST'])
...
@app.route('/categories/<int:category_id>/products/<int:item_id>/delete/',
    methods = ['GET', 'POST'])
...
@app.route('/categories/<int:category_id>/products/<int:item_id>/detail/',
    methods = ['GET', 'POST'])
def detailProduct(category_id, item_id):
    product = session.query(Item).filter_by(id=item_id).one()
    if 'username' not in login_session:
        return render_template('public_product_detail.html', category_id=category_id,
